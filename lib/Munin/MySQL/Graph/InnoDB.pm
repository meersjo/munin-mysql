    ...
    innodb_semaphores => {
        ...
        data_sources => [
            {name => 'ib_spin_rounds',        label => 'Spin Rounds',
                                              info => 'The number of InnoDB semaphore/mutex spin rounds for the internal sync array.'},
            {name => 'ib_spin_waits',         label => 'Spin Waits',
                                              info => 'The number of InnoDB semaphore/mutex spin waits for the internal sync array.'},
            {name => 'ib_os_waits',           label => 'OS Waits',
                                              info => 'The number of InnoDB semaphore/mutex waits yielded to the OS.'},
            {name => 'ib_rw_shared_rounds',   label => 'RW/S Rounds',
                                              info => 'The number of shared (read) semaphore spin rounds within the InnoDB sync array.'},
            {name => 'ib_rw_shared_waits',    label => 'RW/S Waits',
                                              info => 'The number of shared (read) semaphore spin waits within the InnoDB sync array.'},
            {name => 'ib_rw_shared_os_waits', label => 'RW/S OS Waits',
                                              info => 'The number of shared (read) semaphore waits yielded to the OS by InnoDB.'},
            {name => 'ib_rw_excl_rounds',     label => 'RW/X Rounds',
                                              info => 'The number of exclusive (write) semaphore spin rounds within the InnoDB sync array.'},
            {name => 'ib_rw_excl_waits',      label => 'RW/X Waits',
                                              info => 'The number of exclusive (write) semaphore spin waits within the InnoDB sync array.'},
            {name => 'ib_rw_excl_os_waits',   label => 'RW/X OS Waits',
                                              info => 'The number of exclusive (write) semaphore waits yielded to the OS by InnoDB.'},
        ],
    },
